...
[the article on aligning HTML elements to 3D](https://threejs.orghttps://threejs.org/manual/en/align-html-elements-to-3d.html)
and [the article on using indexed textures for picking and color](https://threejs.orghttps://threejs.org/manual/en/indexed-textures.html)
